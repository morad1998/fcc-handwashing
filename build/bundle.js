var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="How to wash your Hand" class="svelte-cc5unp"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-1ggiaob");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "class", "progress-container svelte-1ggiaob");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			t3 = space();
    			h3 = element("h3");
    			h3.innerHTML = `<a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound Source</a>`;
    			t5 = space();
    			audio_1 = element("audio");
    			attr(h1, "class", "svelte-1u86ubr");
    			attr(h3, "class", "svelte-1u86ubr");
